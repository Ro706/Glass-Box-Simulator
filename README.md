...
A: Yes! The tool is free and open-source. Share the link with your students or deploy it yourself.

**Q: Does it work offline?**  
A: Yes! The only online feature is optional Gemini integration for the AI tutor. Everything else works offline.

**Q: Can I add more algorithms?**  
A: Absolutely! Add new implementations to `src/lib/algorithms/`, update the selector, and add algorithm notes.

**Q: Why these 4 algorithms?**  
A: These are the most common pathfinding algorithms in technical interviews and CS curricula. Future versions may expand.

---

## 📞 Support & Contact

- **Issues**: Found a bug? [Open an issue on GitHub](https://github.com/your-repo/issues)
- **Discussions**: Questions or feature ideas? [Start a discussion](https://github.com/your-repo/discussions)
...
- [ ] Add A* with different heuristics (Manhattan, Euclidean, Chebyshev)
- [ ] Add Bellman-Ford algorithm
- [ ] Add dynamic grid resize
- [ ] Add dark/light theme toggle
- [ ] Add problem submission tracking
- [ ] Add import/export grid scenarios
...
- **VisuAlgo** - Inspiration for visualization approach
